...
class GameViewController: UIViewController {
    ...
    var wrongSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("wrong", ofType: "wav")!)
    ...
    func loadNextRandomFlag() {
        if(self.score <= 10)
        {
            var randomNumber = Int(arc4random_uniform(UInt32(flagsArrayEasy.count)))
            self.currentFlag = flagsArrayEasy[randomNumber]
        }
        else
        {
    ...
    func importEasyFlags()
    {
        flagsArrayEasy.append(FlagModel(flagName: "Albania", flagImageName: "Albania", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Austria", flagImageName: "Austria", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Canada", flagImageName: "Canada", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Germany", flagImageName: "Germany", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "United Kingdom", flagImageName: "United Kingdom", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "France", flagImageName: "France", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Russia", flagImageName: "Russia", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Turkey", flagImageName: "Turkey", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Switzerland", flagImageName: "Switzerland", correct: true))
        flagsArrayEasy.append(FlagModel(flagName: "Montenegro", flagImageName: "Montenegro", correct: true))
        
        flagsArrayEasy.append(FlagModel(flagName: "Albania", flagImageName: "wAlbania", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Austria", flagImageName: "wAustria", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Canada", flagImageName: "wCanada", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Germany", flagImageName: "wGermany", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "United Kingdom", flagImageName: "wUnited Kingdom", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "France", flagImageName: "wFrance", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Russia", flagImageName: "wRussia", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Turkey", flagImageName: "wTurkey", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Switzerland", flagImageName: "wSwitzerland", correct: false))
        flagsArrayEasy.append(FlagModel(flagName: "Montenegro", flagImageName: "wMontenegro", correct: false))
    }
}
